...
def reset_taylor():
    """Reseta todas as variáveis globais da fase Taylor para reiniciar"""
...
def taylor_tela(window):
    ...
    if sprite is None:
        sprite = pygame.image.load('assests/sprites/taylor_sprite.png').convert_alpha()
    ...
    # desenha fundo
    background = pygame.image.load('assests/imagens/tela taylor.png').convert()
    ...
    # CRITÉRIO DE VITÓRIA: Se pegar 10 moedas, passa para a Katy Perry!
    if pontos >= 10:
        return SCREEN_KATY
